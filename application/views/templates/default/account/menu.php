    ...
    <div class="user-home-wrapper">
        <div class="mobile-menu-row mobile-menu-header">
            <ul>
                ...
                <?php if(config('allow-members-create-quiz', 1) || is_admin()): ?>
                ...
                <?php if(is_admin()):; ?>
                    <li class="<?php echo ($active == 'dashboard') ? 'active' : null; ?>"  data-title="<?php echo lang('admin_panel') ?>"><a href="<?php echo site_url('admincp') ?>"> <i data-feather="settings"></i></a></li>
                <?php endif; ?>
        ...
        <div class="user-side-bar-menu">
            <ul>
                ...
                <?php if(is_admin()):; ?>
                <li class="<?php echo ($active == 'dashboard') ? 'active' : null; ?>"  data-title="<?php echo lang('admin_panel') ?>"><a href="<?php echo site_url('admincp') ?>"> <i data-feather="settings"></i> <?php echo lang('admin_panel') ?> </a></li>
                <?php endif; ?>
